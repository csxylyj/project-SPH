      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="cartInfo in cartInfoList" :key="cartInfo.id">
          <li class="cart-list-con1">
            <input type="checkbox" name="chk_list" :checked="cartInfo.isChecked==1" @change="updateCheck(cartInfo,$event)">
          </li>
          ...
          <li class="cart-list-con5">
            <a href="javascript:void(0)" class="mins" @click="handle('sub',-1,cartInfo)">-</a>
            ...
            <a href="javascript:void(0)" class="plus" @click="handle('add',1,cartInfo)">+</a>
          </li>
  ...
  export default {
    ...
    methods:{
      ...
      handle:throttle(async function(type,num,cart){
        ...
        try{
          await this.$store.dispatch("reqAddorUpadteShop",{skuId:cart.skuId,skuNum:num})
          this.getData()
        }catch(error){
          alert(error.message)
        }
